...
// link to the system tables using the mongo-collection-instances package. w00t!
TempleSystem['properties'] = Mongo.Collection.get('sys_properties') || new Mongo.Collection("sys_properties");

TempleSystem['modules'] = Mongo.Collection.get('sys_modules') || new Mongo.Collection("sys_modules");

// FIXME :
// old way to do it : declare directly here : TempleSystem['modules'] = new Mongo.Collection("sys_modules");
